...
class StoreList:
    ...
    def clear_list(self, intentMessage):
        ...
        return random.choice(["Die {listName}Liste wurde gelöscht.".fromat(listName=self.callName),
                              ...
                              "Alle Einträge wurden von der {listName}Liste gel�scht.".fromat(listName=self.callName)])
    ...
    def show(self):
        if len(self.storeList) > 1:
            ...
            response = random.choice(["Deine {listName}Liste enth�lt {items} und {last}.".format(listName=self.callName, items=storeList_str, last=self.storeList[-1]),
            ...
            response = random.choice(["Deine {listName}Liste ist leer.".format(listName=self.callName),
                                      "Die {listName}Liste enthält keine Eintr�ge.".format(listName=self.callName),
